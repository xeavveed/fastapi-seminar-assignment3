...
def create_orders(
    ...
    order, stores_data = order_service.create_order(request, user)
...
def get_orders(
    ...
    order ,stores_data = order_service.get_order(order_id, user)
...
def patch_orders(
    ...
    order ,stores_data = order_service.update_order(order_id, request, user)

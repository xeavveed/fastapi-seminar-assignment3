...
def get_review_detail(
    ...
    return review_service.get_review_one(review_id, user.id if user else None)
...
def update_review(
    ...
    return review_service.update_review_for_owner(
        user_id=user.id,
        review_id=review_id,
        req=review_update,
    )
...
def delete_review(
    ...
    review_service.delete_review_for_owner(
        user_id=user.id,
        review_id=review_id,
    )

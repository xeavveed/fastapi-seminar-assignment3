...
def add_item(
    ...
    return item_service.create_item_for_owner(user.id, item)
...
def update_item(
    ...
    return item_service.update_item_for_owner(user.id, item_id, item)
...
def delete_item(
    ...
    item_service.delete_item_for_owner(user.id, item_id)
...
def create_review_for_item(
    ...
    return item_service.create_review_for_item(user.id, item_id, review)
...
def list_reviews_for_item(
    ...
    return item_service.list_reviews_for_item(item_id, user.id if user else None)